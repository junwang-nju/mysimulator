...
namespace std {
  ...
  void FuncFactor_lj612(const double& dsq, const VectorBase<double>& parm,
                        double& funcfac) {
  ...
  void DiffFactor_lj612(const double& dsq, const VectorBase<double>& parm,
                        double& difffac) {
  ...
  void BothFactor_lj612(const double& dsq, const VectorBase<double>& parm,
