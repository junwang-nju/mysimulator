...
#ifndef _System_Evolute_Mode_MinimizerLineRegular_Only_H_
#define _System_Evolute_Mode_MinimizerLineRegular_Only_H_
...
namespace mysimulator {
  ...
  void SysEvoluteModeMLROnly(
    ...
    for(unsigned int i=0;i<SE.size;++i) SE[i].propagate(MinLineRegularShift);
