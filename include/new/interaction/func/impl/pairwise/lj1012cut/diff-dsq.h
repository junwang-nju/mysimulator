...
#ifndef _Interaction_Func_Implement_Pairwise_LJ1012Cut_Diff_DistSQ_H_
#define _Interaction_Func_Implement_Pairwise_LJ1012Cut_Diff_DistSQ_H_
...
namespace mysimulator {
  ...
  template <typename T>
  void DiffLJ1012CutDistSQ(const T* dsq, const Unique64Bit* P, T* diff) {
