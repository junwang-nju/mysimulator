...
namespace mysimulator {
  ...
  ArraySum<Array<T1>,E>
  operator+(Array<T1> const& A, E const& B) {
    return ArraySum<Array<T1>,E>(A,B);
  }
  ...
  ArraySum<Intrinsic<T1>,Array<T2>>
  operator+(Intrinsic<T1> const& A,Array<T2> const& B) {
    return ArraySum<Intrinsic<T1>,Array<T2>>(A,B);
  }
  ...
  ArraySub<Array<T1>,E>
  operator-(Array<T1> const& A, E const& B) {
    return ArraySub<Array<T1>,E>(A,B);
  }
  template <typename EA,typename EB,typename E>
  ...
  template <typename T1,typename T2>
  ArraySub<Intrinsic<T1>,Array<T2>>
  operator-(Intrinsic<T1> const& A,Array<T2> const& B) {
    return ArraySub<Intrinsic<T1>,Array<T2>>(A,B);
  }
  template <typename T,typename EA,typename EB>
  ...
  ArrayMul<Array<T1>,E>
  operator*(Array<T1> const& A, E const& B) {
    return ArrayMul<Array<T1>,E>(A,B);
  }
  template <typename EA,typename EB,typename E>
  ...
  template <typename T1,typename T2>
  ArrayMul<Intrinsic<T1>,Array<T2>>
  operator*(Intrinsic<T1> const& A,Array<T2> const& B) {
    return ArrayMul<Intrinsic<T1>,Array<T2>>(A,B);
  }
  template <typename T,typename EA,typename EB>
  ...
  ArrayDiv<Array<T1>,E>
  operator/(Array<T1> const& A, E const& B) {
    return ArrayDiv<Array<T1>,E>(A,B);
  }
  template <typename EA,typename EB,typename E>
  ...
  template <typename T1,typename T2>
  ArrayDiv<Intrinsic<T1>,Array<T2>>
  operator/(Intrinsic<T1> const& A,Array<T2> const& B) {
    return ArrayDiv<Intrinsic<T1>,Array<T2>>(A,B);
  }
  template <typename T,typename EA,typename EB>
