...
namespace mysimulator {
  ...
  struct MinimizerBase {
    ...
    typedef SpaceVType              VType;
    typedef MinimizerBase<IKType,VType,IPType,T>  Type;
    ...
    MinimizerBase() : MinFunc(), MinX(), MinG(), MinP(), MinMask(), MinUMask(),
                      MinEnergy(0), MinProject(), MinMove(0), GCalcCount(0),
                      SearchScale(0.1), DOF(0) {}
