...
namespace mysimulator {
  ...
  class Array<T,true> {
    ...
    public:
      ...
      typedef void (*_val_copy_type)(Type&,const value_type&);
    ...
    public:
      ...
      Array() : _tag(ArrayKernelName::Unknown), _pdata(), _ndata(0U),
                ...
                _mono_copier ( nullptr ), _val_copier( nullptr ),
                _referer ( nullptr ) {}
      ...
      void reset_kernel(ArrayKernelName KName = ArrayKernelName::Simple) {
        ...
        switch ( _tag ) {
          case ArrayKernelName::Simple:
            ...
            _val_copier = __value_copy_simple<T,value_type>;
      ...
      void swap(Type& A) {
        ...
        std::swap(_val_copier,A._val_copier);
