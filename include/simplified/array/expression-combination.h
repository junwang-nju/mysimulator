...
namespace mysimulator {
  ...
  operator+(const ArraySum<Intrinsic<T1>,E1>& a,
    ...
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E1,E2>>(a.first()+b.first(),a.second()-b.second());
  }
  template <typename T1,typename T2,typename E1,typename E2>
  ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySub<E1,E2>>
  operator+(const ArraySum<E1,Intrinsic<T1>>& a,
            const ArraySub<Intrinsic<T2>,E2>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E1,E2>>(a.second()+b.first(),a.first()-b.second());
  }
  template <typename T1,typename T2,typename E1,typename E2>
  ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySum<E1,E2>>
  ...
  operator+(const ArraySub<Intrinsic<T1>,E1>& a,
            const ArraySum<Intrinsic<T2>,E2>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E2,E1>>(a.first()+b.first(),b.second()-a.second());
  }
  template <typename T1,typename T2,typename E1,typename E2>
  ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySum<E1,E2>>
  operator+(const ArraySub<E1,Intrinsic<T1>>& a,
            const ArraySum<Intrinsic<T2>,E2>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySum<E1,E2>>(b.first()-a.second(),a.first()+b.second());
  }
  template <typename T1,typename T2,typename E1,typename E2>
  ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySub<E2,E1>>
  operator+(const ArraySub<Intrinsic<T1>,E1>& a,
            const ArraySum<E2,Intrinsic<T2>>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E2,E1>>(a.first()+b.second(),b.first()-a.second());
  }
  template <typename T1,typename T2,typename E1,typename E2>
  ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySum<E1,E2>>
  operator+(const ArraySub<E1,Intrinsic<T1>>& a,
            const ArraySum<E2,Intrinsic<T2>>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySum<E1,E2>>(b.second()-a.second(),a.first()+b.first());
  }

  template <typename T1,typename T2,typename E1,typename E2>
  ArraySub<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySum<E1,E2>>
  operator+(const ArraySub<Intrinsic<T1>,E1>& a,
            const ArraySub<Intrinsic<T2>,E2>& b) {
    return ArraySub<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
  ...
  operator+(const ArraySub<E1,Intrinsic<T1>>& a,
            const ArraySub<Intrinsic<T2>,E2>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E1,E2>>(b.first()-a.second(),a.first()-b.second());
  }
  template <typename T1,typename T2,typename E1,typename E2>
  ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySub<E2,E1>>
  ...
  operator-(const ArraySum<Intrinsic<T1>,E1>& a,
            const ArraySum<E2,Intrinsic<T2>>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E1,E2>>(a.first()-b.second(),a.second()-b.first());
  }
  template <typename T1,typename T2,typename E1,typename E2>
  ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
           ArraySub<E1,E2>>
  operator-(const ArraySum<E1,Intrinsic<T1>>& a,
            const ArraySum<E2,Intrinsic<T2>>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E1,E2>>(a.second()-b.second(),a.first()-b.first());
  }
  ...
  operator-(const ArraySum<E1,Intrinsic<T1>>& a,
            const ArraySub<E2,Intrinsic<T2>>& b) {
    return ArraySum<Intrinsic<typename __dual_selector<T1,T2,__sum_flag>::Type>,
                    ArraySub<E1,E2>>(b.second()-a.second(),a.first()-b.first());
  }
