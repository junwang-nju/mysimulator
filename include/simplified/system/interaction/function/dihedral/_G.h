...
#ifndef _System_Interaction_Function_Dihedral_G_H_
#define _System_Interaction_Function_Dihedral_G_H_
...
namespace mysimulator {
  ...
  void _G_dihedral(
    ...
    if( !_status.IsReady4Gradient() ) {
      ...
      if((bool)_neighbor)   _get_pre_for_g_dihedral(_neighbor,_pre,_vec);
      else {
