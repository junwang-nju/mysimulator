...
#ifndef _System_Interaction_Function_Pairwise_StepContinuous_P2P_forG_H_
#define _System_Interaction_Function_Pairwise_StepContinuous_P2P_forG_H_

#include "system/interaction/function/pairwise/step-continuous/_pre_2_post_for_e.h"

namespace mysimulator {

  void _pre_2_post_for_g_pair_step_continuous(
