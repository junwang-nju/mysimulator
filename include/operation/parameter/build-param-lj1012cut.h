...
namespace std {
  ...
  void BuildParameterLJ1012Cut(UniqueParameter* prm) {
    ...
    rc2=prm[LJ1012CutCutR]<T>();
    rc2*=rc2;
    copy(prm[LJ1012CutCutRSQ],rc2);
    r02=prm[LJ1012CutEqRadius]<T>();
    r02*=r02;
    r0rc2=r02/rc2;
    r0rcTEN=r0rc2*r0rc2;
    r0rcTEN*=r0rcTEN;
    ...
    sgrc2=prm[LJ1012CutRealRadiusSQ]<T>()/rc2;
    sgrcTEN=sgrc2*sgrc2;
    sgrcTEN*=sgrcTEN;
    sgrcTEN*=sgrc2;
    ...
    e0-=prm[LJ1012CutVc]<T>();
    e0-=prm[LJ1012CutKc]<T>()
        *(prm[LJ1012CutEqRadius]<T>()-prm[LJ1012CutCutR]<T>());
    tmd=-prm[LJ1012CutEqEnergyDepth]<T>()/e0;
    copy(prm[LJ1012CutRealEnergyDepth],tmd);
    prm[LJ1012CutVc]<T>()*=tmd;
    prm[LJ1012CutKc]<T>()*=tmd;
    copy(prm[LJ1012CutSixtyRealEnergyDepth].d,60*tmd);
  }
