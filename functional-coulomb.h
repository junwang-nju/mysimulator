...
namespace std {
  ...
  void FuncFactor_coulomb(const double& dsq, const VectorBase<double>& parm,
                          double& funcfac) {
    funcfac=parm[coulomb_Strength]/sqrt(dsq);
  }

  void DiffFactor_coulomb(const double& dsq, const VectorBase<double>& parm,
                          double& difffac) {
    double d=sqrt(dsq)*dsq;
    difffac=-parm[coulomb_Strength]/d;
  }

  void BothFactor_coulomb(const double& dsq, const VectorBase<double>& parm,
