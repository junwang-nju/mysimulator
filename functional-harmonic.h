...
namespace std {
  ...
  void FuncFactor_harmonic(const double& dsq, const varVector<double>& parm,
                           double& funcfac) {
    double d=sqrt(dsq);
  ...
  void DiffFactor_harmonic(const double& dsq, const varVector<double>& parm,
                           double& difffac) {
    double d=sqrt(dsq);
    double Dd=d-parm[harmonic_EqLength];
  ...
  void BothFactor_harmonic(const double& dsq, const varVector<double>& parm,
