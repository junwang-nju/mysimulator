...
namespace std {
  ...
  void E_ParPar_LJ612Cut(const varVector<Property*>& P,
    ...
    E_ParPar_Base(P,Parm,DEval,Geo,Energy,FuncFactor_lj612cut);
  }
  ...
  void G_ParPar_LJ612Cut(varVector<Property*>& P,
                         const varVector<double>& Parm, DistEvalObj& DEval,
                         const GeomType& Geo) {
    G_ParPar_Base(P,Parm,DEval,Geo,DiffFactor_lj612cut);
  }
  ...
  void EG_ParPar_LJ612Cut(const varVector<Property*>& P,
                          const varVector<double>& Parm, DistEvalObj& DEval,
                          const GeomType& Geo, double& Energy) {
    EG_ParPar_Base(P,Parm,DEval,Geo,Energy,BothFactor_lj612cut);
  }
