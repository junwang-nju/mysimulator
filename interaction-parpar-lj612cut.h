...
namespace std {
  ...
  void E_ParPar_LJ612Cut(const VectorBase<refVector<double>*>& P,
  ...
  template <typename DistEvalObj, typename GeomType>
  void G_ParPar_LJ612Cut(const VectorBase<refVector<double>*>& P,
  											 const VectorBase<uint>& Idx,
  											 const VectorBase<uint>& KIdx,
                         const ParamList& PList,
                         DistEvalObj& DEval, const GeomType& Geo,
  ...
  template <typename DistEvalObj, typename GeomType>
  void EG_ParPar_LJ612Cut(const VectorBase<refVector<double>*>& P,
  											 	const VectorBase<uint>& Idx,
  											 	const VectorBase<uint>& KIdx,
                          const ParamList& PList,
                          DistEvalObj& DEval, const GeomType& Geo,
