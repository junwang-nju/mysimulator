...
#include "parameter-generate-lj612cut.h"
#include <iostream>
using namespace std;
...
int main() {
  ...
  prm[1]=1.;
  prm[2]=4.;
  ParameterGenerateLJ612Cut(prm);
  double E=0.;
  EFunc_ParticleParticle_LJ612Cut(v,vi,prm,v,vDED,vFS,E);
  cout<<E<<endl;
  cout<<endl;

  cout<<"Test -- GFunc"<<endl;
  GFunc_ParticleParticle_LJ612Cut(v,vi,prm,v,vDED,vFS,g);
  cout<<g<<endl;
  cout<<endl;
  ...
  E=0.;
  gd=0.;
  BFunc_ParticleParticle_LJ612Cut(v,vi,prm,v,vDED,vFS,E,g);
  cout<<E<<endl;
  cout<<g<<endl;
  cout<<endl;
