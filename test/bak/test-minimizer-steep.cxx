...
int main() {
  ...
  SteepestDescentMinimizer4PropertyList<DistanceEvalDirect,FreeSpace,
                                        StrongWolfe,
  ...
  SDM.ImportState(CoorSeq,Mask,dMask,vDED,vFS,ParamLst,vIM,IdxLst);
  cout<<SDM.MinE<<endl;
  cout<<endl;
