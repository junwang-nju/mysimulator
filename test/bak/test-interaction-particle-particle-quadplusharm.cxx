...
int main() {
  ...
  double E=0.;
  EFunc_ParticleParticle_QuadPlusHarm(v,vi,prm,v,vDED,vFS,E);
  cout<<E<<endl;
  cout<<endl;

  cout<<"Test -- GFunc"<<endl;
  GFunc_ParticleParticle_QuadPlusHarm(v,vi,prm,v,vDED,vFS,g);
  cout<<g<<endl;
  cout<<endl;
  ...
  E=0.;
  gd=0.;
  BFunc_ParticleParticle_QuadPlusHarm(v,vi,prm,v,vDED,vFS,E,g);
  cout<<E<<endl;
  cout<<g<<endl;
  cout<<endl;
