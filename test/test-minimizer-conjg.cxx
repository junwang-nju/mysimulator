...
int main() {
  ...
  ConjugateGradientMinimizer4PropertyList<DistanceEvalDirect,FreeSpace,
                                          StrongWolfe,
  ...
  CGM.ImportState(CoorSeq,Mask,dMask,vDED,vFS,ParamLst,vIM,IdxLst);
  cout<<CGM.MinE<<endl;
  cout<<endl;
