...
#include "interaction-pairwise-fene.h"
...
int main() {
  ...
  prm[FENEStrength]=1.;
  prm[FENEBoundLength]=2.;
  GenerateParameterFENE(prm);

  cout<<"Test -- EFunc"<<endl;
  double E=0.;
  EFuncPairwiseFENE(v.structure,idx(),prm(),2,NULL,0,DED,FS,E);
  cout<<E<<endl;
  cout<<endl;

  cout<<"Test -- GFunc"<<endl;
  assign(g.data,0.,g.size);
  GFuncPairwiseFENE(v.structure,idx(),prm(),2,NULL,0,DED,FS,g.structure);
  cout<<g<<endl;
  cout<<endl;
  ...
  E=0.;
  assign(g.data,0.,g.size);
  BFuncPairwiseFENE(v.structure,idx(),prm(),2,NULL,0,DED,FS,E,g.structure);
  cout<<E<<endl;
  cout<<g<<endl;
  cout<<endl;
