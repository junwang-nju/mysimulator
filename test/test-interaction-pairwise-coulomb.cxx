...
int main() {
  ...
  prm[CoulombStrength]=1.;
  GenerateParameterCoulomb(prm);

  cout<<"Test -- EFunc"<<endl;
  double E=0.;
  EFuncPairwiseCoulomb(v.structure,idx(),prm(),2,NULL,0,DED,FS,E);
  cout<<E<<endl;
  cout<<endl;

  cout<<"Test -- GFunc"<<endl;
  assign(g.data,0.,g.size);
  GFuncPairwiseCoulomb(v.structure,idx(),prm(),2,NULL,0,DED,FS,g.structure);
  cout<<g<<endl;
  cout<<endl;
  ...
  E=0.;
  assign(g.data,0.,g.size);
  BFuncPairwiseCoulomb(v.structure,idx(),prm(),2,NULL,0,DED,FS,E,g.structure);
  cout<<E<<endl;
  cout<<g<<endl;
  cout<<endl;
