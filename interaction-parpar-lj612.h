...
namespace std {
  ...
  void E_ParPar_LJ612(const VectorBase<PropertyComponent<refVector>*>& P,
  ...
  template <typename DistEvalObj, typename GeomType>
  void G_ParPar_LJ612(const VectorBase<PropertyComponent<refVector>*>& P,
                      const varVector<uint>& Idx,const varVector<uint>& KIdx,
                      const ParamList& PList,
                      DistEvalObj& DEval, const GeomType& Geo,
  ...
  template <typename DistEvalObj, typename GeomType>
  void EG_ParPar_LJ612(const VectorBase<PropertyComponent<refVector>*>& P,
                       const varVector<uint>& Idx,const varVector<uint>& KIdx,
                       const ParamList& PList,
                       DistEvalObj& DEval, const GeomType& Geo,
                       double& Energy,
