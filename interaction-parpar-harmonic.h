...
namespace std {
  ...
  void E_ParPar_Harmonic(const VectorBase<Property<refVector>*>& P,
  ...
  template <typename DistEvalObj, typename GeomType>
  void G_ParPar_Harmonic(const VectorBase<Property<refVector>*>& P,
                         const VectorBase<uint>& Idx,
                         const VectorBase<uint>& KIdx,
                         const ParamList& PList,
                         DistEvalObj& DEval, const GeomType& Geo,
  ...
  template <typename DistEvalObj, typename GeomType>
  void EG_ParPar_Harmonic(const VectorBase<Property<refVector>*>& P,
                          const VectorBase<uint>& Idx,
                          const VectorBase<uint>& KIdx,
                          const ParamList& PList,
                          DistEvalObj& DEval, const GeomType& Geo,
