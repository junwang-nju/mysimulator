...
This is qualitatively consistent with the previous studies.

The zeros of the partition functions of the polymers with various lengths are
calculated with PLOY algorithm (using the program Scilab). Since the coefficients
of the equation $Z(s)=0$ are all real, the roots generally form the conjugate
pairs except the real roots. In these solutions of $\beta$, there are no positive
...
this transition would be the adsorption transition of the polymer system. The
...
length. Based on the above discussions about partition zeros, these zeros
...
$\phi=0.50658 \pm 0.00379$. With this exponent, the collapse transition
...
and the corresponding adsorption transition temperature is $T_c=2.095 \pm 0.014$.
